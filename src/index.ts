...
// DIRECT CROSSMINT PAYMENT ENDPOINT - WORKING VERSION
app.post('/api/crossmint/payment', async (req, res) => {
  try {
    const { amount, currency, customerEmail } = req.body;
    const walletAddress = '0xee556510Fb70F7F1F1484C22B4D584A871cD204c';
    const apiKey = process.env.CROSSMINT_CLIENT_ID || 'ck_production_5TG2w7cbr8tedKZgwitEuQ7jNxKeMkogaguzWppLkGjZjg5XCcs89pcT4gA1PGU3TFmrortokDisZBLZcDSFumLmy8Z1NxKHBsXPv9TmQUqVcjGQnMqLVyTVkCofoP5hQS5aiuUEXomRjft5GqquGDdwNPU5hVWhKmofnMdgB9wM3XmDVuNjjfb6CMywAGsa1hALBgv6pPGnzkJT3F8UyVzD';
    const projectId = '13eb3ce8-b831-4927-b560-42ef8d55ca9e';

    console.log('Creating payment for:', { amount, currency, customerEmail });
